...
def load_fixture(name: str) -> dict[str, Any]:
    """Load one sanitized JSON fixture without importing production contracts."""
...
def evaluate_semantic_result(raw: object, context: object) -> Any:
    """Call the production validator after the test has assembled its inputs."""

    from neontof.contracts.semantic_result import validate_semantic_result

    return validate_semantic_result(raw, context)
